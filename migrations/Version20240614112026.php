 ...
 */
final class Version20240614112026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage ADD user_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(255)  NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage DROP user_id, CHANGE nom nom VARCHAR(255) DEFAULT NULL');
    }
}
